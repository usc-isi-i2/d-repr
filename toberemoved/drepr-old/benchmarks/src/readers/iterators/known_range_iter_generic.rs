...
/// # Examples
#[derive(Debug)]
pub struct KnownRangeIter<I: std::convert::AsRef<[Index]> + std::convert::AsMut<[Index]> + std::fmt::Debug> {
...
impl<I: std::convert::AsRef<[Index]> + std::convert::AsMut<[Index]> + std::fmt::Debug> KnownRangeIter<I> {
  pub fn new(
    index: I,
    unfrozen_dims: Vec<usize>,
    lowerbounds: Vec<usize>,
...
impl<I: std::convert::AsRef<[Index]> + std::convert::AsMut<[Index]> + std::fmt::Debug> IndexIterator for KnownRangeIter<I> {
  #[inline]
  fn value(&self) -> &[Index] {
