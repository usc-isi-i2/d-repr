...
from drepr.models.align import AlignedStep, RangeAlignment
...
from drepr.models.sm import ClassNode, DataNode, DataType, Edge, SemanticModel
    ...
    gold_ds_model = DRepr(
        ...
        [
            Preprocessing(
                ...
                PMap(
                    "default",
                    PathParserV1().parse(gold_resource, "$[2:][1:]", ""),
                    "return float(value)\n",
                    None,
                    None,
                ),
        ...
        [
            Attr(
                "area",
                "default",
                PathParserV1().parse(gold_resource, "$[2:][0]", ""),
                [-999],
                True,
                Sorted.Ascending,
                ValueType.List_Int,
            ...
            Attr(
                "gender",
                "default",
                PathParserV1().parse(gold_resource, "$[1][1:]", ""),
                [],
                False,
                Sorted.Null,
            ...
            Attr(
                "period",
                "default",
                PathParserV1().parse(gold_resource, "$[0][1:]", ""),
                [],
                False,
                Sorted.Null,
                ValueType.Unspecified,
        ...
        SemanticModel(
            nodes={
                ...
                "dnode:period": DataNode(
                    "dnode:period", "period", DataType("xsd:anyURI")
                ),
        ...
        "attrs": [
            {
                "id": "area",
                "missing_values": [-999],
                "path": {"steps": [{"end": None, "start": 2, "step": 1}, {"val": 0}]},
                "resource_id": "default",
                "sorted": "ascending",
                "unique": True,
                "value_type": "list[int]",
            },
            {
                "id": "gender",
                "missing_values": [],
                "path": {"steps": [{"val": 1}, {"end": None, "start": 1, "step": 1}]},
                "resource_id": "default",
                "sorted": "none",
                "unique": False,
            ...
            },
            {
                "id": "period",
                "missing_values": [],
                "path": {"steps": [{"val": 0}, {"end": None, "start": 1, "step": 1}]},
                "resource_id": "default",
                "sorted": "none",
                "unique": False,
                "value_type": "unspecified",
